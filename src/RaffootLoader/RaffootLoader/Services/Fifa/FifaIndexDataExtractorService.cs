...
{
	public class FifaIndexDataExtractorService(ISettings settings) : FifaService, IFifaDataExtractorService
	{
		...
		private static HttpClient GetHttpClient()
		{
			...
			client.GetAsync(BaseUrl).ConfigureAwait(false);
