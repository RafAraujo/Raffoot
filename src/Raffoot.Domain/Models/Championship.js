class Championship {
    ...
    get groupClubCount() {
        return this.regulation === 'groups' ? Config.cup.groupClubCount : null;
    }

    get groupCount() {
        return this.regulation === 'groups' ? this.clubCount / Config.cup.groupClubCount : 0;
    }
    ...
    getEliminationDateCount() {
        switch (this.regulation) {
            case 'groups':
                return _genericEliminationDateCount(Config.cup.groupCount * Config.cup.groupQualifiedClubCount, this.isTwoLeggedTie);
            case 'elimination':
    ...
    getGroupDateCount() {
        return this.regulation === 'groups' ? (Config.cup.groupClubCount - 1) * (this.isTwoLeggedTie ? 2 : 1) : 0;
    }
}